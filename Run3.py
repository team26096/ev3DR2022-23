...
def alignToSmartGrid():
    ...
    robot.reset()
    robot.follow_gyro_angle(3, 0, 0, -12, target_angle=155, 
...
def doSmartGrid():
    ...
    # run_for_motor_stalled(mm_vertical, 10000, -65)
    # mm_vertical.reset()
    mm_vertical.on_for_degrees(65, -495, brake=True, block=True)
...
def doHybridCar():
    ...
    mm_vertical.on_for_degrees(-65, 775, brake=True, block=True)
def collectRB():
    #go back to base
    robot.reset()
