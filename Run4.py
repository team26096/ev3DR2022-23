...
def run4():
    ...
    logfile.info('=====> run 4 recharableBattery start')
    recharableBattery()
    logfile.info('=====> run 4 recharableBattery end')
    logfile.info('=====> run 4 watchTelevison stat')
    watchTelevison()
    logfile.info('=====> run 4 watchTelevison end')
    logfile.info('=====> run 4 fuelTruck start')
    fuelTruck()
    logfile.info('=====> run 4 fuelTruck end')
    logfile.info('=====> run 4 windTurbine start')
    windTurbine()
    logfile.info('=====> run 4 windTurbine end')